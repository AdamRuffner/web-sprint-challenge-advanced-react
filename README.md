...
1. Explain how to build stateful class components.
  - extend the react component, set state, write what is needed for jsx.
2. Describe the different phases of the component lifecycle.
  - initialize monuting, updating, unmounting. 
3. Demonstrate an understanding of class component lifecycle methods.
  - mounting gets will get mounted to the DOM, updating will re-render the page, unmounting will unmount it from the DOM
4. Define stateful logic.
  - any code using state, or with hooks will be a beahvior created. 
5. Describe how to test a React component with React Testing Library.
  - by using Arrange, Act, and Assert. Also by importing render, fireEvent, and screen.
